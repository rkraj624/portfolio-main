  ...
  return (
    <section id="projects" className="py-20 px-6 max-w-6xl mx-auto">
      ...
      >
        ...
        <div>
          <h2 className="text-2xl sm:text-3xl font-bold">Enterprise Key Highlights</h2>
          <p className="text-sm text-gray-400">High-impact production solutions delivered at scale</p>
        </div>
      </motion.div>

      {/* Enterprise Projects Cards Grid with 3D Parallax Tilt */}
      <motion.div 
        initial="hidden" 
        whileInView="visible" 
      ...
      {personalProjects && personalProjects.length > 0 && (
        <div className="mt-20">
          ...
          {/* Animated Carousel Card View with 3D Tilt */}
          {currentProject && (
