  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-colors duration-300 py-4 ${scrolled ? 'bg-[#090d16]/95 backdrop-blur-md shadow-2xl' : 'bg-transparent'}`}>
      <div className="max-w-6xl mx-auto px-6 flex items-center justify-between">
        <a href="#" className="flex items-center gap-2 font-mono text-lg font-bold tracking-tight text-white hover:opacity-80 transition group">
          <span className="w-8 h-8 rounded-lg bg-gradient-to-tr from-indigo-500 to-sky-400 flex items-center justify-center text-white text-sm shadow-md shadow-indigo-500/20 icon-3d">RR</span>
        ...
        <div className="hidden md:flex items-center gap-3">
          <a 
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold bg-gradient-to-r from-sky-500 to-indigo-600 hover:from-sky-400 hover:to-indigo-500 text-white btn-3d"
          >
            <FileDown size={16} className="icon-3d" /> Resume
          </a>
        </div>
